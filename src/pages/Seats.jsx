  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#05060A] text-white">
        <div className="h-8 w-8 animate-spin rounded-full border-2 border-zinc-800 border-t-[#ed1c24]" />
      </div>
    );
  }
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-[#08090D] px-2 py-6 sm:px-5">
              ...
              {Object.entries(
                ...
                >
                  ...
                  <div className="mb-3 flex items-center justify-between px-8">
                    ...
                    <div>
                      <p className="text-[9px] font-bold uppercase tracking-[1.5px] text-white">
                        {category}
                      </p>

                      <p className="mt-0.5 text-[8px] text-[#ed1c24]">
                        ₹
                        {
                          priceMap?.[category]
                            ?.price
                  ...
                  {Object.entries(rows).map(
                    ([row, rowSeats]) => (
                      ...
                      >
                        ...
                        {/* Left Row Label */}
                        <span className="mr-2 w-3 text-right text-[8px] font-semibold text-zinc-500">
                          {row}
                        </span>
                            ...
                            (seat, index) => (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  className={`h-[18px] w-[18px] rounded-[4px] border text-[6px] font-bold transition-all sm:h-[20px] sm:w-[20px] ${
                                    seat.isBooked
                                      ? "cursor-not-allowed border-red-950 bg-[#171719] text-zinc-700"
                                      : isSelected(
                                          seat._id
                                        )
                                      ? "border-red-400 bg-[#ed1c24] text-white shadow-[0_0_12px_rgba(237,28,36,0.6)]"
                                      : "border-[#ed1c24]/70 bg-[#141416] text-red-300 hover:scale-110 hover:border-red-400 hover:bg-[#1d1d20] hover:shadow-[0_0_8px_rgba(237,28,36,0.3)]"
                                  }`}
                                >
                                  {seat.column}
                                </button>
                        ...
                        {/* Right Row Label */}
                        <span className="ml-2 w-3 text-[8px] font-semibold text-zinc-500">
                          {row}
                        </span>
          ...
          <div className="mx-auto mt-6 flex max-w-[600px] justify-center gap-5 border-t border-white/[0.05] pt-4 text-[8px] text-zinc-500 sm:gap-8">
            ...
            <div className="flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-[2px] bg-[#f1f0e8]" />
              Available
            </div>

            <div className="flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-[2px] bg-[#3f4000]" />
              Booked
            </div>

            <div className="flex items-center gap-1.5">
              <span className="h-2.5 w-2.5 rounded-[2px] bg-[#ed1c24]" />
              Selected
            </div>
        ...
        <div className="fixed bottom-3 left-1/2 z-50 w-[calc(100%-16px)] max-w-[700px] -translate-x-1/2 rounded-xl border border-white/[0.08] bg-[#111113]/95 px-3 py-2.5 shadow-2xl backdrop-blur-xl sm:bottom-5 sm:px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[7px] uppercase tracking-[1.5px] text-zinc-500">
                Selected
              </p>

              <p className="mt-0.5 truncate text-[9px] font-semibold text-white">
                {selectedSeats.length
                  ? selectedSeats
                      .map(
                        (seat) =>
            ...
            <button
              ...
              className="rounded-lg bg-[#ed1c24] px-4 py-2.5 text-[9px] font-bold text-white transition hover:bg-[#d91820] active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 sm:px-6"
            >
              Proceed
            </button>
